...
public class PentominoShape extends JPanel{
	...
	public void update(){
		...
		if(!(yPos+ 1 + position.length > grid.getyAxis()))
		{
...

			{
				...
				time = 0;
				grid.score += 1;
				Window.score.setText("Score: " + grid.score);
				Window.lCleared.setText("Lines cleared: " + grid.linesCleared);
			}
		}else{
			collisionY = true;
		}
