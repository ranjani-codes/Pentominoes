...
public class PentominoShapes {
    ...
    private int normalSpeed = 600, fastSpeed = 10;//Speeds of normal fall down frequency and when pressing the Down key to accelerate the fall
    ...
    public void Update() {
        ...
        if (time > normalSpeed){ //the time that passed is > the frequency time we want it goes down, go down
            yPos++;
            time = 0;
        }

        deltaX = 0; //Will prevent the piece to go to infinity Left or Right
    }
